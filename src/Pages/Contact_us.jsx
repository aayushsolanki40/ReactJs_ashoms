    ...
    const form_handle = (e) => {
        ...
        if(Email==""){
            ...
            if(validateEmail(Email)){
                ...
                setEmail_err("Please enter valid enter email.");
                isValidate=false;
            }
        }
         
        if(Full_name==""){
            setFull_name_err("Please enter enter your full name.");
            isValidate=false;
        }
        ...
        if(isValidate){
            requestContactUs(Email, Full_name, Subject, Message).then(meta =>{
                if(meta.status){
