...
import {getLinkedinAccessToken, getUserdataByToken, resendOTP, signupAPI} from '../API/Userapis';
...
const Loginpage = (props) => {
    ...
    if(validate){    
        axios({
            method: "post",
            url: "https://testnet.ashom.app/api/webservice/login",
            data: bodyFormData,
                ...
                <div className='container'>
                   ...
                   <div className='row'>
                        <Card  variant="outlined" className="col-md-4 col-sm-8 offset-md-4 offset-sm-2 section_divider authPage_form_div">
                            ...
                            <div className={'form-group'}>
                            <Checkbox {...label} id="remember_me_text" onChange={()=>remberChange()} /><label htmlFor="remember_me_text"> Remember Me</label>
                            </div>
