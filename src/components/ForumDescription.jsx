...
import {timeSince, getForumComments, getCommentReplies} from '../API/Userapis';
...
const Forumdescription = (props) => {
    ...
    // if(repliesArr.length>current_replies_count){
    //     let replayarr = repliesArr;
    //     setrepliesArr(replayarr.slice(0, current_replies_count));
    // }
    ...
    function refreshCommentsReplies(){
    ...
    const handlermorereplies = (chatdata) =>{
        ...
        navigate("/forums/replies/"+(parseInt(repliedCount)+1))
